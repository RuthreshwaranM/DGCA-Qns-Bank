...
c. 12210
*d. 12864
Explanation: 1. TRUE ALTITUDE = ALTITUDE ON QNH (ISA DEVIATION x 4 x PRESSURE ALTITUDE ÷ 1000) Alt on QNH = 12000ft Isa deviation = 18 (supposed to be -9 but it is 9) Ta =[12000 + (18x4x12000) ] /1000 Ta = 12864
...
*c. 216.5°K
d. -56.5°C
Explanation: The ICAO ISA is defined as follows:- a MSL temperature of 15°C ft) a constant temperature of –56.5°C from 11 km (36,090ft) to 20 km (65,617 ft) after which the temp increases with height (inversion). hence lowest is -56.5°C CONVERT THE ANSWER IN KELVIN 273 (-56.5) = 216.5°K
...
4. In the Northern Hemisphere a man observes a low pressure system passing him to the south, from west to east. What wind will he experience?
a. Backs the Veers
*b. Constantly backs
c. Veers then Backs
d. Backs than steady
...
6. When would a rotor cloud be ahead of a Cb?
*a. Mature stage
b. Cumulus stage
c. Dissipating stage
d. Initial stage Above picture shows mature stage roll cloud are also rotor clouds
...
8. What are the conditions under which advection fog will be formed?
...
10. What cloud does hail fall from?
*a. Cb
b. Ns
c. Cu
d. Ci
...
13. If the ELR is 0.65°C/100m
a. atmosphere is conditionally stable
b. atmosphere is stable
c. atmosphere is unstable
*d. atmosphere is stable when dry

14. Where are you most likely to find moderate to severe icing?
a. In upper levels of Cumulonimbus Capillatus
*b. Nimbostratus
c. Stratus
d. Cirrus
Explanation: Rain ice occurs in a narrow range of altitudes at low level, about 1000 ft, ahead of a warm front or occlusion and is associated particularly with the moderate continuous rain which often falls from Nimbo Stratus cloud

15. Height of the tropopause at 50° N
*a. 11 Km
b. 16 Km
c. 5 Km
d. 20 Km

16. What kind of weather system might you typically find between the 45° – 70°N?
a. Sub tropical highs
b. Polar highs
*c. Polar front depressions
d. Arctic front depressions

17. Flying from London to Bombay in January, what average wind might you expect?
a. Light easterly
*b. Light westerly
c. Westerly polar front jet stream
d. Tropical Easterly jet
Explanation: The direction of jet streams is generally westerly, maximum speeds occur near the tropopause, 200 kts have been recorded in Europe/N Atlantic and 300 kts in Asia. hence westerly would be prominent the pole

18. What is most different about the Equatorial Easterly jet stream?
a. It’s height
b. It’s length
*c. It’s direction
d. It’s speed

19. What pressure systems affect the North Atlantic in summer?
...
Explanation: North American or Canadian Low replaces Winter High. Icelandic “Statistical” Low 1010 mbs. Less deep and split. Azores High 1025 hPa intensified. Further North at 35°N. Hurricanes in Caribbean and Florida area.

20. Flying towards a warm front, at what distances might you expect the following cloud types from the surface position of the front?
*a. CS 600km; AS 400km: NS 200km
b. CS 200km: AS 400 km: NS 600km
c. CS 800km: AS 200km: NS 400km
d. CS 400km: AS 600km: NS 800km

21. A characteristic of a stable air mass
a. lapse rate of 1°C/100 m
b. rising air slows down and dissipates
*c. lapse rate of 0.3°C/100 m
d. good visibility and showers

22. How do you recognise high level jet streams and associated CAT?
a. High pressure centre at high level
*b. Streaks of Cirrus
c. High level dust
d. Lenticularis
Explanation: From the ground, when the cloud amounts allow, jets may be recognised by wind blown wisps of CIRRUS cloud blowing at right angles to the clouds at lower levels.

23. Which conditions lead to mountain waves?
...
26. Which of the following indicates upper level instability and possible the formation of TS?
a. Halo
b. Red cirrus
c. Altocumulus Lenticularis
*d. Altocumulus castalanus

27. Where is the largest chance of squalls occurring?
*a. In front of an active cold front
b. Above the occlusion along the cold front
c. Behind the cold front
d. Above the occlusion along the warm front Squall line with embedded bowing line segments often located along or north of warm front southward across warm sector along or ahead of cold front.

28. When are the north Atlantic lows at their most southerly position?
a. Spring
b. Summer
c. Autumn
*d. Winter
...
Explanation: The ELR now matches the DALR, meaning that dry parcels will be neutral, with no vertical movement (DALR = ELR > SALR).

30. Typical tornado diameter
a. Less than 100 m
*b. 100 -150m
c. 2 -6 km
d. More than 10 km tornadoes 100m to 150 m

31. For the same pressure gradient at 50N, 60N and 40N, the geostrophic wind speed is?
a. Greatest at 60N
b. Least at 50N
*c. Greatest at 40N
d. The same at al latitudes

32. In the area of the ITCZ why are the heights of the tropopause not reported?
...
Explanation: the trade-winds converge and air rises high into the upper reaches of the “troposphere.” The strong updraft in the ITCZ raises the tropopause, the upper boundary of the troposphere, to about 15 km height

33. Flying condition in Ci cloud and horizontal visibility
...
34. A parcel of air cooling by more than 1°C/100m is said to be?
a. Conditionally stable
b. Conditionally unstable
*c. Unstable
d. Stable

35. Flying over an airfield, at the surface the temp is -5ºC, freezing level is at 3000ft, rain is falling from clouds with a base of 4000ft caused by warm air rising above icing?
a. Never
b. No icing because your not in cloud
c. Between 3000 -4000ft
*d. Below 3000ft
Explanation: met reports inversion warm air rising (increase in temp with height) -5° at ground then 0° level will be just above hence Yes, between ground level and 3000 FT/AGL

36. Where are easterly and westerly jets found?
*a. Northern hemisphere only
b. Southern hemisphere only
c. Northern and southern hemisphere
d. There are no easterly jets.

37. Climbing out of Dhahran, Saudi Arabia on a clear night you suddenly lose your rate of climb. Why?
a. Engine full of sand
b. Downdraft
*c. Marked temperature inversion
d. VSI blocked
Explanation: Vertical windshear is change in wind velocity with height. It is typically measured in knots per 100ft. This type of windshear is very common during an inversion, therefore expect them at night and in well developed high pressure systems such as those found under the sub tropical high pressure belt. As an aeroplane fly’s through an inversion, not only will the change of temperature cause the engine performance to change, but the abrupt change in wind speed and direction may significantly alter the flight path. render function for question type not found

38. At 15,000ft in nimbostratus cloud with an outside air temperature of -12°C, what icing might you expect?
a. Moderate rain ice.
b. Moderate to severe mixed ice.
*c. Moderate to severe ice if orographicaly intensified.
d. Light rime ice.

39. What cloud types are classified as medium cloud?
a. Ns + Sc
*b. Ac + As
c. Cb + St
d. Ci + Cs

40. Comparing rain to drizzle, visibility will generally…?
a. Rain has a visibility of 1 km, drizzle has 2 km
b. Remains the same
c. Deteriorate
*d. Improve

41. What is the approximate height of the tropopause at 50ºN?
a. 14 km
b. 13 km
*c. 11 km
d. 16 km

42. What statement is true regarding the tropopause?
...
`);
registerChapterText("atpl-met", "part-2", "Part 2", `
1. Please refer to Appendix F (attached on the next page) What is the temperature deviation, in degrees Celsius, from the International Standard Atmosphere overhead Frankfurt (50N 08E) at FL 180?
a. ISA +2°C
*b. ISA -13°C
c. ISA +13°C
d. ISA -2°C

2. What type of cloud is associated with drizzle?
*a. St
b. Cb
c. Ci
d. Ac
Explanation: Stratus (from Latin stratum, meaning strewn) is generally a grey, layered cloud with a fairly uniform base, which may produce drizzle or light snow. Stratus cloud is no more than 1,000-1,500ft thick, and is often much thinner. Stratus is usually the lowest of all cloud types.
...
4. What cloud type are you least likely to get icing from?
*a. Ci
b. Cu
c. St
d. Ns

5. TAF’s are usually valid for
...
c. Polar night jet
*d. Sub tropical jet
Explanation: Sub tropical jetsteams form in the area of the sub-tropical anti- cyclones. They are more or less permanent but move seasonally with the sub-tropical highs. They occur in the latitude bands 25° to 40° in winter and 40° to 45° in summer. The jet core is at the 200 hPa level.
...
c. D
d. C
Explanation: Altocumulus lenticularis, also known as lenticular cloud, is found downwind of mountainous or hilly areas, and is indicative of the presence of mountain wave activity. Because of its position downwind of high ground, moderate or even severe turbulence may be found beneath altocumulus lenticularis.

8. The surface wind circulation found between the sub tropical highs and the equatorial lows are called?
a. The doldrums
*b. The trade winds
c. The easterlies
d. The westerlies

9. In a high pressure systems
...
10. If you fly with left drift in the Northern Hemisphere, what is happening to your true altitude?
*a. Increases
b. Decreases
c. Stays the same
d. Cannot tell
Explanation: Buys Ballot’s Law states that: If an observer stands with his back to the wind, the lower pressure is on his left in the northern hemisphere, and on his right in the southern hemisphere. A corollary of this law is that if an aircraft is experiencing starboard drift in the northern hemisphere the aircraft is heading towards low pressure in this case the drift is to the left (port) hence heading towards high pressures True altitude in High pressure or warm atmosphere is always more than cold/low,

11. What type of icing requires immediate diversion?
a. Light
b. Moderate
*c. Severe
d. extreme

12. Where does freezing rain come from?
...
13. Flying from Dakar to Rio de Janeiro, where is the ITCZ in winter?
a. >8ºS
*b. 0 -7ºN
c. 8 -12ºN
d. 12 -16ºN

14. What is the feature W?
*a. Warm occlusion.
b. Cold occlusion.
c. Quasi stationary front.
d. Warm front.

15. A man is flying East to West in the Northern Hemisphere. What is happening to his altitude?
...
c. Liquid to vapour
d. Liquid to solid
Explanation: Freezing If the water droplet is cooled below zero, then it may change state again to ice. Melting The opposite change of state, from solid to liquid, is called melting Sublimation/Deposition Sublimation is the change of state directly from water vapour to ice without water droplets being formed. Latent heat is released. This process is also known as deposition. sublimation.

17. In central Europe in summer, under the influence of a polar depression in a wide warm sector, you would expect the following wx:
a. Thunderstorms and rain showers
*b. Low stratus and drizzle
c. Fair weather Cu
d. Clear skies

18. What is the coldest time of the day?
a. 1hr before sunrise
b. 30 min before sunrise
c. at exact moment of sunrise
*d. 30 min after sunrise
Explanation: As per the diurnal variation of temperature: from 15:00 LMT onwards, the temperature falls continuously until a little after sunrise. The lowest temperature occurs at about sunrise plus 30 minutes (TMIN).

19. An Easterly wave will produce:
a. Frontal weather
*b. Thunderstorms and rain
c. Low stratus
d. Clear skies

20. The line connecting A to B crosses what pressure system:
a. A trough
*b. A ridge
c. A front
d. An occlusion

21. Which coast of the USA is affected by the most frequent hurricanes:
a. NE
b. NW
*c. SE
d. SW

22. Which of the following would lead to the formation of Steaming fog
*a. cold air over warm sea
b. warm air over cold sea
c. cold sea near coast
d. warm air over land
Explanation: Steaming fog, or as it is sometimes called, Arctic Smoke, occurs over sea in polar regions, eg the fjords of Greenland, Iceland and the sea areas of high latitudes. It is caused by cold air from a land of evaporation from the sea is enough to cause saturation and condensation but the air itself must be very stable.

23. QNH at Timbuktu (200m AMSL) is 1015 hPa. What is the QFE? (Assume 1 hPa = 8m)
a. 1000
*b. 990
c. 1020
d. 995

24. Paris reports OVC 8/8 St at +3 ° C during the day. What will happen on the night of 3/4 Jan
a. slightly above +3°
*b. sligltly below +3°
c. stays at +3°
d. well below 0°

25. The Arctic Jet core is at:
*a. 20,000 ft
b. 30,000 ft
c. 40,000 ft
d. 50,000 ft
Explanation: Arctic Jet Stream: In winters, long polar night cools the polar air forming an arctic air mass between (roughly) 70 deg latitude and causes arctic jet stream. The core is at 20,000 feet and max speed around 80 knots.

26. With a cold front over the North Sea, what weather would you expect 300km behind the front?
a. Stratus with drizzle
b. Thunderstoms and heavy showers
*c. Scattered Cu and showers
d. Clear skies

27. If flying cross country at FL50 you first see NS, AS, CC then CI, you can expect:
a. Increasing temperature
*b. Decreasing temperature
c. A veer in the wind
d. Increase in pressure
Explanation: Warm front approach with cold air ahead

28. Surface wind is 320/12 what is the wind at 2000ft in the Northern hemisphere?
a. 330/25
b. 220/20
*c. 270/20
d. 210/12

29. Lucarno airfield elv 1735 ft altimeter indicates 1310 ft with 1013hPa set what is the QNH?
a. 990hPa
b. 980hPa
*c. 1028hPa
d. 998hPa

30. Prevailing winds in North West. Africa will be
...
32. The letters NC used at the end of a SIGMET, mean:
a. No cloud
*b. No change
c. No cumulus
d. Not clear

33. In temperate latitudes in summer what conditions would you expect in the centre of a high pressure system?
a. TS, CB
*b. calm winds, haze
c. TS, SH
d. NS
Explanation: High pressure areas are typically associated with poor visibility (fog/haze) despite otherwise good weather.

34. Above a stable layer in the lower troposphere in an old high pressure system is called:
a. radiation inversion
*b. subsidence inversion
c. frontal inversion
d. terrestrial inversion
Explanation: In a high pressure system, air descends at the centre. As the air descends it is heated adiabatically and becomes warmer than the air at a lower level adjacent to the surface. This is called a Subsidence Inversion.

35. Which way does a depression move?
...
36. If the pressure level surface bulges upwards, the pressure system is a:
a. cold, low
b. warn, low
c. cold, high
*d. warm, high
Explanation: Pressure level will bulge upwards in high pressure or warm air mass and other way in a low or cold

37. Freezing rain is most likely from
a. Warm front in summer
b. Cold front in summer
*c. Warm front in winter
d. cold front in winter

38. With regard to RVR and Met vis
...
39. When travelling from Stockholm (55N 18E) to Rio de Janeiro (22S 80W), do you encounter:
a. Polar Front jet stream then sub tropical jet then polar jet
*b. Polar Front jet then 1 or 2 sub tropical jets
c. One Sub tropical jet stream
d. One sub tropical jet stream then one polar front jet
Explanation: rio is located at 23° s stockholm at 59° n will cross polar and few stj as per the diagram

40. Why does air cool as it rises?
*a. It expands
b. It contracts
c. The air is colder at higher latitudes
d. The air is colder at higher altitudes
Explanation: a parcel of air was forced to rise in the atmosphere, the decreasing ambient pressure would cause the parcel to expand, much like an air bubble does when it rises through a champagne glass. As the air rises and expands, it will cool adiabatically.

41. What is the validity of a significant weather chart
a. 3 hrs
b. 6 hrs
*c. 9 hrs
d. 12 hrs

42. When flying at FL180 in the Southern Hemisphere you experience a left crosswind. What is happening to your true altitude if indicated altitude is constant?
a. Remains the same
*b. Increasing
c. Decreasing
d. Impossible to tell
Explanation: In N hemisphere Starboard drift= flying into low pressure Port drift= flying into high pressure In S hemisphere Starboard drift= flying into high pressure Port drift= flying into low pressure Ac gets starboard drift due to winds from left Starboard drift Ac is flying into high pressure When flying from Low to high altimeter will under-read Hence it is under reading the altitude in actual it has increased

`);
registerChapterText("atpl-met", "part-3", "Part 3", `
1. What is the main feature of the initial stage of a thunderstorm
a. Downdrafts
*b. up currents
c. rain
d. rotor cloud

2. In a polar front jet stream in the Northern Hemisphere, where is there likely to be the greatest probability of turbulence?
...
Explanation: Polar front jetstreams form in the polar front region in both hemispheres,in southern around 50° S and near any front which is separate from the polar front. air will be to the left hand side in northern hemisphere and to the right hand side in the southern hemisphere. Clear air turbulence (CAT). occurs around the boundaries of jet streams because of the large horizontal and vertical windshears. It is strongest near to, or just below, the jet axis on the cold air (low pressure) side with a secondary area above the axis.
...
4. On the chart below, where is rain least likely
a. EBBR
*b. Madrid
c. Paris
d. LOWW

5. Flying from Marseilles (QNH 1012) to Palma (QNH 1015) at FL100. You dont reset the altimeter, why would true altitude be the same throughout the flight?
...
Explanation: Ac is flying into high pressure When flying from Low to high altimeter will under-read but True altitude is same The true altitude of this surface will depend on the density of the air below flying from marseille where the qnh is lower to Palma where the qnh is higher you would normally expect your true altitude to Palma

6. On a flight from Zurich to Rome, which of the following METARS would be applicable?
a. London
b. Shannon
c. Madrid
*d. Milan

7. Which of the following is true about freezing precipitation?
...
8. How do you define convection?
a. Horizontal movement of air
*b. Vertical movement of air
c. Same as advection
d. Same as conduction
Explanation: Air heated by conduction will be less dense and will therefore rise. This will produce up currents called thermals or convection currents. These currents will help to transfer heat to different parts of the atmosphere. For example, warm air will rise to the upper levels, thus helping to heat the upper atmosphere.

9. How does clear ice form?
*a. SWD’s speading on impact
b. Ice pellets shattering on impact
c. Frost on the wing
d. Water vapour freezing on the aircraft surface
Explanation: supercooled water droplets Glaze ice or clear ice is formed when LARGE supercooled drops spread over wings rime ice is formed WHEN SMALL supercooled drops spread over wings both happen under 0° Celsius flying through clouds

10. When is the latest time radiation fog is most likely?
*a. Just after dawn
b. Late afternoon
c. Midday
d. Midnight Radiation fog is caused by radiation of the earth’s heat at night, and the subsequent conductive cooling of the air in contact with the ground to below dew point.

11. On the chart below, for the route Edinburgh to Zurich, state the optimum flight level.
a. FL220
*b. FL240
c. FL370
d. FL390

12. How does the level of the tropopause vary with latitude in the Northern Hemisphere?
...
13. Where do you find the majority of the air within atmosphere?
*a. Troposphere
b. Stratosphere
c. Tropopause
d. Mesosphere
Explanation: The Troposphere This is layer in the atmosphere closest to the earth’s surface and it is defined by the fact that temperature decreases with height by approximately 0.65°C/100 m (1.98°C/1000 ft). It consists of ¾ of weather. On average this layer extends from the surface to a 11 km.

14. How can you determine QNH from QFE
a. Temperature and elevation
*b. Elevation
c. Pressure and temperature
d. Temperature
Explanation: difference between qfe and qnh is elevation
...
Explanation: The Bora. This wind is part valley and part katabatic. It blows down the north Adriatic with high pressure over Central Europe and the Balkans and a low over the Adriatic. The wind speed is around 70 kts with great gusts exceeding 100 kts in places. The Bora is strongest and most frequent in winter.

16. Where is the 300mb level approx. in ISA?
*a. 30,000 ft
b. 39,000 ft
c. 18,000 ft
d. 10,000 ft
Explanation: refer and remember this chart

17. A winter day in N Europe with a thick layer of SC and surface temperature zero degrees C. You can expect
a. Decreasing visibility due to snow below the cloud base and light icing in cloud
b. High probability of icing in clouds, Severe icing in the upper levels due to large droplets
c. Turbulence due to a strong inversion, but no icing due to clouds being formed from ice crystals
*d. Reduced visibility and light icing in cloud
Explanation: Radiation Fog can form inland with a slack pressure gradient, principally in Autumn and Winter. With a SW warm moist wind from the Atlantic, advection fog can form over previously cold soaked inland areas. Smoke haze may reduce visibility to the lee of industrial areas. Frontal fog can occur on the warm fronts of deep active Polar Front depressions. Icing. As over the North Atlantic, icing occurs widely and through great depth in Frontal Cloud and is frequently moderate to severe. Freezing Rain (Rain Ice) can cause severe clear ice in cold air under a warm front or warm occlusion. A rare occurrence in UK, it is more common over Central Europe where the ground is generally much colder, indeed the freezing level may frequently be on the surface especially in the East.

18. What is the usual procedure when encountering CAT en-route?
...
Explanation: In the Air, the presence of a jet will be difficult to SEE, but temperature differences, increases in windspeed, drift and clear air turbulence are all evidence of jet streams. Clear air turbulence (CAT). occurs around the boundaries of jet streams because of the large horizontal and vertical windshears. It is strongest near to, or just below, the jet axis on the cold air (low pressure) side with a secondary area above the axis. if you encounter descent immediately

19. An aircraft flies into an area of supercooled rain with a temperature below zero, what kind of icing is most likely
*a. Clear
b. Rime
c. Hoar frost
d. Granular frost
Explanation: Glaze ice or clear ice is formed when LARGE supercooled drops spread over wings rime ice is formed WHEN SMALL supercooled drops spread over wings

20. When are cyclones most likely?
a. Mid Winter
b. Late Autumn
*c. Late Summer
d. Late Spring
Explanation: Tropical revolving storms are known as cyclones in the Bay of Bengal. To form they need a summer warm sea (evidence suggests in excess of 27°C. and the close instability of the ITCZ. In July the ITCZ is north, over the land, so that in this area they form only in early and late summer when the ITCZ is over the sea, that is in June or October.

21. If Paris has a surface wind of 160/40, what is the wind at 2000 ft
*a. 180/60
b. 120/40
c. 160/60
d. 160/40
Explanation: The surface wind over land is backed by 30 degrees from the geostrophic wind and its speed is reduced by 50%. Hence going up speed will increase and direction will be move towards clockwise

22. When are the rains most likely in Equatorial Africa?
a. March to May, August to October
*b. March to May, October to November
c. June to July
d. December to January
Explanation: two ITCZ transits in the year each give their own instability rainfall pattern. ITCZ passage will be northbound (March/May) and will be followed by the moist SE trade winds from the Indian Ocean. Rainfall will be extensive and is known as the Long Rains.

23. What causes convection in a low pressure system
a. Height
b. Latitude
c. Centripetal force
*d. Friction

24. What is the likely hazard association with the Harmattan?
*a. Poor visibility from dust and sand
b. Sand up to FL150
c. Thunderstorms
d. Dense fog
Explanation: The Harmattan is a cool dusty wind that may reduce visibility to below 1000m, especially in areas bordering desert regions, such as Kano, Nigeria. The dust layer may extend to 7,000 or 10,000 ft or more, visibility improves towards the coast. The Harmattan blows from November through to April, though by this time the winds will be light, especially in the south.

25. You are flying at FL120 with a true altitude of 12,000ft, why would this be
...
27. What will snow most likely fall from?
*a. Ns
b. Ci
c. Cs
d. Ac

28. Considering the North Atlantic area at 60 N in winter, the mean height of the tropopause is approximately
a. 56,000 ft
b. 37,000 ft
*c. 29,000 ft
d. 70,000 ft

29. Rime ice is caused by:
...
Explanation: rime ice is formed WHEN SMALL supercooled drops quickly spread over wings happens under 0° Celsius flying through clouds

30. An unsaturated parcel of air is forced to rise through an isothermal layer. As long as it stays unsaturated the temperature of the parcel will
a. Remain the same
...
Explanation: Dry or unsaturated air that is forced to rise or descend within the atmosphere changes its temperature by 1°C per 100m (3°C/1000ft). This is called the Dry Adiabatic Lapse Rate (DALR) and it is fixed. If dry air is disturbed it will rise and cool at the DALR of 1°C/100m, and will therefore be colder at 100m than its surroundings.

31. What is the most severe form of icing?
a. Dry ice
b. Hoar frost
*c. Clear ice
d. Rime ice
Explanation: Clear ice is very dangerous. There can be much flowback and the ice appears transparent because there is no air trapped under the strength and because it has less air in it this type of ice is much stronger and much harder to remove. The ice will destroy aerofoil shapes and its weight can cause problems of control because the build-up can be uneven. Propeller icing can cause severe vibrations and as the ice adheres strongly, when it breaks off, the pieces can be large and cause skin damage.

32. What happens to the polar front jet stream in NH winter compared to summer?
*a. Moves south, speed increases
b. Moves North, speed increases
c. Moves South, speed decreases
d. Moves North, speed decreases
Explanation: Polar Front jets in the Northern Hemisphere move north and decrease in speed as the Polar Front moves north in summer. During winter the Polar Front moves south and, because of the greater temperature difference, the speed increases.

33. Duration of a microburst:
*a. 5 mins, 5 km
b. 20 mins, 5 km
c. 15 mins, 25 km
d. 45 mins, 25 km
Explanation: They are concentrated in a burst which is up to 3nm (5km) in horizontal length and have a lifetime of about 5 minutes. (A Macroburst is a similar event but over a bigger area.)

34. Where is the surface wind usually westerly in a Northern Hemisphere polar front depression?
a. In front of the warm front
*b. In front of the cold front
c. Behind the cold front
d. To the north of the centre of the depression
Explanation: At position b the winds are westerly, which is just in front of the cold front; blue triangles denote the cold front.

35. Flying from an area of low pressure in the Southern Hemisphere at low altitudes, where is the wind coming from?
...
Explanation: Wind flow is clockwise around a low in the S. hemisphere. Flying away from the L means the wind must be from the left for it to also be flowing clockwise around the low. surface friction preventing flow being truly parallel to the isobars. The pressure system mentioned is a Low so air will tendflow into the Low, in addition to clockwise around this S. hemisphere Low. You’re flying away from the low at low altitude (therefore friction effects), the wind has a tendency to flow into the low so there will also be a slight headwind component.

36. What causes the Geostrophic wind to be stronger than the gradient wind around a low?
...
Explanation: Gradient Wind In A Depression If air is moving steadily around a depression, then the centrifugal force opposes the PGF and therefore reduces the wind speed. You can see this on the left hand side of the image shown below. geostrophic wind for the same isobar interval. Hence if the Geostrophic Wind Scale (GWS) is used, it will overread.

37. A METAR for Paris gave the surface wind at 260/20. Wind at 2000ft is most likely to be:
a. 260/15
b. 210/30
*c. 290/40
d. 175/15
Explanation: The surface wind over land is backed by 30 degrees from the geostrophic wind and its speed is reduced by 50% in northern hemisphere, hence Geostrophic wind of290/40 will reduce by half 15 kts and back by 30° which is 260°

38. When the upper part of a layer of warm air is advected:
...
Explanation: If upper part has cold air that means temperature is decreasing with height and If the ELR is greater than 1°C/100 m, the air is unstable – absolute instability.

39. The QNH at an airfield 200m AMSL is 1009 hPa; air temperature is 10°C lower than standard. What is the QFF?
a. Not possible to give a definite answer
b. Less than 1009
c. 1009
*d. More than 1009

40. A plain in Western Europe at 500m (1600ft) AMSL is covered with a uniform alto – cumulus cloud during summer months. At what height AGL is the base of the cloud expected?
a. 100 -1500ft
b. 15000 -25000ft
*c. 7000 -15000ft
d. 1500 -7000ft
Explanation: Altocumulus usually occur between 8,000 and 15,000 ft with tops on some occasions as high as 23,000 ft. Usually the cloud base is between 6,500 ft and 20,000 ft.

41. A pilot experiences severe turbulence and icing. A competent met. man would issue:
a. SPECI
b. METAR
c. TEMPO
*d. SIGMET
Explanation: SIGMET stands for Significant Meteorological Information. A SIGMET is an abbreviated, plain language message which concerns the occurrence, and/or expected occurrence, of significant weather which may affect the operational safety of aircraft.

42. What wind would you expect between the equator and 20° south?
a. NE monsoon
*b. Trade wind
c. Strong westerlies
d. Roaring forties
...
`);
registerChapterText("atpl-met", "part-4", "Part 4", `
1. Where is the most severe weather in a TRS?
a. in the centre of the eye
*b. in the wall of cloud surrounding the eye
c. within the eye
d. 300km from the eye

2. A large pressure gradient is shown by:
...
Explanation: Pressure gradient is the horizontal rate of change of pressure perpendicular to be isobars directed from high to low pressure it is to be steep isobars are closely packed closer the isobars stronger the winds as wind tend to flow towards low pressure area

3. The degree of CAT experienced by an aircraft is proportional to:
...
Explanation: Clear air turbulence (CAT). occurs around the boundaries of jet streams because of the large horizontal and vertical windshears. It is strongest near to, or just below, the jet axis on the cold air (low pressure) side with a secondary area above the axi
...
5. Which of the following are described as precipitation?
a. TS
b. SQ
c. SA
*d. DZ

6. An aircraft flying in the Alps on a very cold day, RPS 1013 set in the altimeter, flies level with the summit of the mountains. Altitude from aneroid altimeter reads:
a. Same as mountain elevation
b. Lower than mountain elevation
*c. Higher than mountain elevation
d. Impossible to determine
Explanation: If temperature is warmer than ISA then TRUE > INDICATED and if it’s colder than ISA then TRUE < INDICATED. molecules in cold air are closely packed molecules in warm air are loosely packed a column of cold air on the left, and a column of warm air on the right. Notice that, since cold air causes pressure to fall more rapidly with height, the pressure levels in the cold air column are compressed towards the Earth’s surface, whereas, in the warm air column, they expand away from the surface. if 1013 is set on a cold day the aircraft will over read elevation than actual Remember HIGH LOW HIGH (over read) WARM COLD OVEREAD

7. Clouds classified as low level are considered to have a base height of:
a. 500 -1000ft
b. 1000 -2000ft
...
Explanation: Polar front jetstreams form in the polar front region in both hemispheres,in southern around 50° S and near any front which is separate from the polar front. The upper winds will blow such that looking downstream the cold air will be to the left hand side in northern hemisphere and to the right hand side in the southern hemisphere. streams because of the large horizontal and vertical windshears. It is strongest near to, or just below, the jet axis on the cold air (low pressure) side with a secondary area above the axis.

9. A after such a fine day yesterday, the ring around the moon indicated bad weather today. Sure enough, it is pouring down rain, with a very low cloud base of uniform grey. It is a little warmer though. This describes:
*a. A warm front
b. A cold front
c. The weather behind a cold front
d. Poetic licence
Explanation: Approaching ci clouds Cirrostratus is made up of ice crystals, and lies between 18,000 and 45,000 ft. Cirrostratus is a further warning of an approaching to appear with a halo. Heavy rain and dark ns clouds

10. On a flight from London to New York in summer, where would you cross the ITCZ?
a. Newfoundland, Grand Banks
b. New York
c. Azores
*d. You wouldn’t
Explanation: London latitude is 51° New York latitude is 40 ° position of itcz

11. What type of low is usually associated with frontal activity?
*a. Polar front low
b. Mountain lee low
c. Warm low
d. Cold low
Explanation: When a small depression is enclosed within the circulation of a larger depression it is called a secondary. The isobars need not show a closed centre. Secondaries are particularly associated with frontal depressions and form Travelling Polar Front Lows in the Southern Hemisphere’s disturbed temperate zone will themselves be located well south of the route; but associated troughs, and secondary lows, can bring frontal weather as far north as the Australian South Coast and to New Zealand.

12. When would you encounter hoar frost?
*a. a. Climbing through an inversion
b. Ns
c. Cb
d. Ac
Explanation: Hoar frost is a white crystal deposit which appears similar to frost on the ground. It occurs in clear air. Hoar frost will form if the airframe temperature is below 0°C and the ambient temperature is lowered to saturation level.Water vapour in contact with the airframe is converted to ice crystals without becoming liquid, i.e. sublimating. when temperature from ground increases with increasing height it is called inversion, which means ground is colder or ambient is cold

13. What is the temperature decrease with height below 11km?
a. 1°C -100m
b. 0.5°C -100m
*c. 0.65°C -100m
d. 0.6°C -100m
Explanation: The ICAO ISA is defined as follows:- a MSL temperature of 15°C a lapse rate of 0.65°C/100m (1.98° C /1000 ft) up to 11 km (36,090 ft) a constant temperature of –56.5°C from 11 km (36,090ft) to 20 km (65,617 ft) after which the temp increases with height (inversion). hence lowest is -56.5°
...
d. Height of ground
Explanation: A Constant Pressure or Contour Chart is a chart where the pressure is constant everywhere. For example, as shown on the previous page we can see that the 800 mb pressure level varies with height. These heights are plotted as contour lines with the reference being MSL. The heights give us an indication of the distance that a pressure level is from MSL. Charts are drawn for the following pressure levels: 700 hPa – 10,000 ft 500 hPa – 18,000 ft 250 hPa – 34,000 ft 200 hPa – 39,000 ft 100 hPa – 53,000 ft

15. Equatorial easterly jets
*a. Northern Hemisphere in summer
b. Northern Hemisphere all year
c. Southern Hemisphere all year
d. Southern Hemisphere

16. Aircraft with thick wing (T) and thin wing (S) fly at the same TAS and altitude through cloud containing small super cooled water droplets. What extent of icing will be experienced?
a. S and T same icing
b. Nothing as its super cooled water droplets
*c. S more, T less
d. T more, S less

17. What surface weather is associated with a stationary high pressure region, over land, in the winter?
a. Ns and continuous rain
*b. A tendency for fog and low Stratus
c. The possibility of snow showers
d. Thunderstorms
Explanation: High pressure area are related to bad visibility and good weather,

18. Where would you expect to find the strongest wind on the ground in temperate latitudes?
*a. In an area of Low pressure
b. In an area of High pressure
c. In the warm air between two fronts
d. In a weak anticyclone
Explanation: As the storm system expands to much larger scale, the action of the Earth’s rotation becomes significant, and, unlike in the small scale low, the airflow is deflected as it is drawn towards the centre of the wind speeds of up to 200 miles per hour

19. Landing at an airfield with QNH set the pressure altimeter reads:
...
20. Where are the fastest winds in a Tropical Revolving Storm?
a. Near the eye
*b. In the wall of cloud surrounding the eye
c. To the right of the track
d. To the right of the track in Hurricanes and Cyclones

21. What type of cloud is usually found at high level?
a. St
b. Ac
*c. Cc
d. Ns

22. You are flying in an atmosphere which is warmer than ISA, what might you expect?
...
Explanation: temperature is warmer than ISA then TRUE > INDICATED and if it’s colder than ISA then TRUE < INDICATED. molecules in cold air are closely packed molecules in warm air are loosely packed a column of cold air on the left, and a column of warm air on the right. Notice that, since cold air causes pressure to fall more rapidly with height, the pressure levels in the cold air column are compressed towards the Earth’s surface, whereas, in the warm air column, they expand away from the surface. The aircraft will Indicated lower altitude than actual actual altitude is more than indicated

23. The environmental lapse rate in the real atmosphere:
a. Has a fixed value of 20C / 1000ft
b. Has a fixed value of 0.650C / 100Mtrs
*c. Varies with time
d. Has a fixed value of 10C / 100Mtrs
Explanation: in a stationary or static atmosphere under ISA conditions the temperature decreases with height at approximately 0.65°C per 100m. We called this lapse rate the environmental lapse rate (ELR). It is important because this variable lapse rate controls the stability of the air. We also mentioned that the ELR changed from day to height (inversions) sometimes is was constant with height (isotherms). However, there is another type of temperature change that occurs in our atmosphere that takes place when air is moved.

24. Sub tropical highs are found:
a. 5 -15º
*b. 25 -35º
c. 40 -60º
d. Between the Polar and Ferrell cells

25. The QNH is 1030Hpa and at the Transition Level you set the SPS. What happens to your indicated altitude?
*a. Drops by 510ft
b. Rises by 510ft
c. Rises
d. Drops
Explanation: As we know pressure falls with height, 1013 hpa will be found above 1030 in the atmosphere, if 1013 is at sea level, 1030 is below sea 510 feet,as you can see from the diagram 1013 hpa set on altimeter will give less elevation, it drops by 510 feet

26. What is the movement of air relating to a ridge?
*a. Descending and diverging
b. Ascending and diverging
c. Descending and converging
d. Ascending and converging
Explanation: A ridge is a high pressure area; in a high pressure area the wind subsides and diverges.

27. What would the code 01650428 tell you about the condition of the runway?
a. Its raining
b. its snowing
*c. braking co-efficient of 0.28
d. its broken

28. What time of year is the tornado season in N. America?
*a. Spring to summer
b. Summer and autumn
c. Spring
d. Summer
Explanation: Tornado season refers to the time of year the U.S. sees the most tornadoes. The peak season for the southern Plains (e.g. Texas, Oklahoma and Kansas) is from May into early June; on the Gulf coast it is earlier, in spring. In the northern Plains and upper Midwest (North and South Dakota, Nebraska, Iowa, Minnesota), tornado season is in June or July. Tornadoes can occur at any time of year or day, though most occur between 4-9pm.

29. What is the min. temperature according to ISA?
*a. -56.5°C
b. -273°C
c. -100°C
d. 215.6°K
...
30. At a coastal airfield, with the runway parallel to the coastline. You are downwind over the sea with the runway to your right. On a warm summer afternoon, finals?
*a. crosswind from the right
b. Headwind
c. Tailwind
d. Crosswind from the left

31. What symbol is used to describe wide spread haze?
a. B
*b. A
c. C
d. D

32. What symbol is used to describe freezing rain?
a. B
b. A
c. C
*d. D

33. The temperature at the surface is 15°C, the temperature at 1000m is 13°C. Is the atmosphere
a. Unstable
b. Conditionally unstable
*c. Stable
d. Cannot tell
Explanation: The ICAO ISA is defined as follows:- a MSL temperature of 15°C a lapse rate of 0.65°C/100m (1.98° C /1000 ft) up to 11 km (36,090 ft) a constant temperature of –56.5°C from 11 km (36,090ft) to 20 km (65,617 ft) If these conditions prevail atmosphere is stable
...
35. Small super cooled water droplets hit the aerofoil, will it
...
Explanation: Glaze ice or clear ice is formed when LARGE supercooled drops spread over wings rime ice is formed WHEN SMALL supercooled drops spread over wings both happen under 0° Celsius flying through clouds

36. In a METAR you see the coding R16/P1300. What does this imply?
*a. RVR assessed to be more than 1300 meters
b. RVR equipment is problematic
c. RVR is improving
d. RVR is varying
Explanation: R16 means Runway 16; P means 'plus', meaning the RVR for Runway 16 is more than 1300 metres.

37. If at 0600 the temperature and dew point were recorded as T= – 0.5 and Td = – 1.5, how would a METAR record this?
a. M01, M02
b. M01, M01
*c. M00, M01
d. 00, M01
Explanation: The temperature shall be separated from the dew point with a solidus “/“. The temperature and dew point shall be coded as two digits rounded to the nearest whole degree Celsius. For example, a temperature of 0.3oC would be coded as “00“. Sub-zero temperatures and dew points shall be prefixed with an M. For example, a temperature of 4oC with a dew point of -2oC would be “M00“.

38. What is the approximate height of the 250hPa level?
a. 30,000ft
b. 32,000ft
c. 39,000ft
*d. 34,000ft
Explanation: Refer the chart 850 hpa is 5000 pressure altitude or fl50

39. Several aircraft report clear air turbulence in a certain area en route
...
Explanation: SIGMET, or Significant Meteorological Information, is a severe weather advisory that contains meteorological information concerning the safety of all aircraft. Compared to AIRMETs, SIGMETs cover more severe weather, hence atc should issue sigmet

40. What is the flight hazard associated with the Harmattan?
a. Sand up to FL150
b. Wind shear
*c. Dust and poor visibility
d. Dense fog
Explanation: The Harmattan is a cool, dusty wind that may reduce visibility to below 1000m, especially in areas bordering desert regions such as Kano, Nigeria. The dust layer may extend to 7,000 or 10,000ft or more; visibility improves towards the coast. The Harmattan blows from November through to April, though by then the winds will be light, especially in the south.
...
c. Severe
d. Extreme
Explanation: ICAO “No change of course and altitude necessary” recommendation be followed? — “Light” ICAOs change of course and/or altitude “desirable recommendation” be followed? — “Moderate” ICAOs change of course and/or altitude “immediately instruction” be followed? — “Severe”

42. Aircraft A has a sharp leading edge and a thin aerofoil. Aircraft B has a thick cambered wing aerofoil. If they are flying at the same TAS into clouds with small super cooled water droplets then
...
`);
registerChapterText("atpl-met", "part-5", "Part 5", `
...
2. The polar front jet stream in summer compared to winter in the Northern Hemisphere moves
...
Explanation: Polar Front Jets in the northern hemisphere will move north (and decrease in speed) as the Polar Front moves north in summer. During the winter the Polar Front moves south and because of the greater temperature difference, the speed will increase.
...
4. In which air mass can extreme cold temperatures be found?
*a. Polar continental
b. Arctic maritime
c. Polar maritime
d. Tropical maritime
Explanation: If the airmass is lying over a warm tropical ocean, the airmass is classified as Tropical Maritime (TM). If the airmass lies over a cold continent in winter, the airmass is classified as Polar Continental (PC).

5. Super cooled water droplets are found in
a. Clouds only
*b. Clouds, fog and precipitation
c. Precipitation and clouds
d. Precipitation
Explanation: Supercooled water droplets can exist in clouds at temperatures as low as -40°C. Freezing fog is an example of supercooled drops in fog freezing rain is an example of supercooled drops in precipitation

6. Which of the following, with no Orographic intensification, will give rise to light to moderate icing conditions?
a. Ns and Cs
*b. As and Ac
c. Cb and Ns
d. Ns and Cc
Explanation: Orographic Lifting occurs when air is forced to rise and cool due to terrain features such as hills or mountains. If the cooling is sufficient, water vapor condenses into clouds. Additional cooling results in rain or snow WHEREAS ALTOSTRATUS CLOUDS AND ALTO CUMULUS Altostratus clouds form when a large mass of warm air rises, causing water vapor in the atmosphere to condense onto nuclei (small dust particles), forming water droplets and ice crystals. These conditions usually happen at the leading edge of a warm front, where cirrostratus clouds thicken and lower until they transition into altostratus clouds Altocumulus clouds can form in several ways, such as; Formation through the breakup of altostratus The lifting of moist air pockets which are cooled by gentle turbulence These 2 types of cloud are medium level cloud and have light to moderate level of icing and are not produced by orographic lifting

7. What would be reflected to radar?
a. Fog
*b. Hail
c. Cloud
d. Mist
Explanation: hail causes echo on AIR BORNE WEATHER RADAR The optimum radar frequency is one that has a wavelength comparable to the size of the objects which we wish to detect, namely the large water droplets and wet hail which in turn are associated with severe turbulence; these droplets are about 3 cm across. The typical frequency adopted by most commercial systems is 9375 MHz, /-30 MHz

8. A jet stream with a wind speed of 350kts
a. Impossible
*b. Possible but very rare
c. Possible in polar areas
d. Common
Explanation: The direction of jet streams is generally westerly, maximum speeds occur near the tropopause, 200 kts have been recorded in Europe/N Atlantic and 300 kts in Asia. In equatorial regions there are however some easterly jets

9. Turbulence is worst in a Jet stream
a. In the core
...
Explanation: Clear air turbulence (CAT). occurs around the boundaries of jet streams because of the large horizontal and vertical windshears. It is pressure) side with a secondary area above the axis.

10. If you fly at right angles to a jet stream in Europe with a decreasing outside air temperature, you will experience
...
Explanation: TEMPO, means that the change is temporary, and that the different conditions will prevail for periods of less than one hour, only, and no more than half the time period ts means thunderstorm
...
d. It depends on QFE
Explanation: If an unsaturated parcel of air rises (either because it’s buoyant or it is forced to do so) it will cool adiabatically. This cooling increases the relative humidity of the parcel of air until eventually the temperature of parcel has reached dew point temperature and the relative humidity will be 100%.At this point the air parcel is saturated and further ascent and cooling will cause condensation and cloud to form. The level in the atmosphere at which this of any cloud formations but his all happens when it reaches the condition level in this case it doesn’t reach the condensation level and descends back to its original position If the lifted air’s lapse rate (either dry or saturated) is the same as the environmental lapse rate then we have neutral stability. This is because the temperature change of the lifted air will be the same temperature change as the environmental air. Therefore, at every level the air is forced to rise, it will have the same temperature as the surrounding air and therefore the same density. As a result the air will remain where it is displaced to.

14. What most likely gives freezing rain over Central Europe?
a. Warm occlusion
b. Cold occlusion
*c. Warm front
d. Cold front
Explanation: As over the North Atlantic, icing occurs widely and through great depth in Frontal Cloud and is frequently moderate to severe. Freezing Rain (Rain Ice) can cause severe clear ice in cold air under a warm front or warm occlusion. A rare occurrence in UK, it is more common over Central Europe where the ground is generally much colder, indeed the freezing level may frequently be on the surface especially in the East.

15. Which of the cuts in the plan view of the polar front depression best represents the profile view?
a. A, B
b. B, C
*c. C, D
d. D, E
Explanation: Looking at the plan view you can see a typical polar front depression on the polar front. Notice the intrusion of the tropical maritime air creating the characteristic wedge shape known as the warm sector. To the right of the warm sector is the warm front, marked with red semicircles to signify that warm air is overriding and replacing cold air. To the left of the warm sector is the cold front, marked with blue triangles to signify that cold air is undercutting and replacing warm air. (Diagram-based question - refer to the original chart.)

16. In the Northern Hemisphere between lat. 35°N – 65°N in the north Atlantic during winter, the principle land based depression affecting the region is located at
a. USA high
b. Siberia high
*c. Greenland/Icelandic low
d. Azores high
Explanation: Icelandic low, large persistent atmospheric low-pressure centre that forms between Iceland-and southern Greenland. It often causes strong winter winds over the North Atlantic Ocean. In winter the ocean is considerably warmer than the continents, and this difference is responsible for the location of the Icelandic low, which dominates the wind circulation over the North Atlantic

17. Clear ice is most likely to form
*a. -10°C to -17°C
b. -30°C to -40°C
c. -20°C to -30°C
d. -40°C to -60°C
Explanation: Glaze ice or clear ice is formed when LARGE supercooled drops spread over wings rime ice is formed WHEN SMALL supercooled drops spread over wings both happen under 0° Celsius flying through clouds large supercool water sustain only between 0 to -20 degree

18. Which cloud would you encounter the most intensive rain?
a. Ci
*b. Ns
c. St
d. Sc
Explanation: Nimbostratus is a dense, dark-grey, rain-bearing, stratiform cloud, producing extensive and long-lasting continuous precipitation. Usually the cloud base is between the surface and 10,000ft above ground level.

19. What height is the tropopause and at what temperature?
a. At the poles 8km and -16°C
b. At the pole 18km and -75°C
c. At the equator 8km and -40°C
*d. At the equator 18km and -76°C
Explanation: Since temperature decreases with height it goes to follow that the temperature at the tropopause is controlled by its height. The higher it is, the colder the temperature at the tropopause. The lower it is, the warmer the temperature at the tropopause. The temperature at the tropopause can be as high as -40°C over the poles and as low as -80°C over the equator. However, on average the tropopause is at about 11 km where its temperature is -56.5°C.

20. Flying from Dakar to Rio de Janeiro in winter where would you cross the ITCZ?
*a. 0 to 7°N
b. 7°N to 12°N
c. 7°S to 12°S
d. 12°S to 18°S

21. With low pressures dominating the Med, which of the following would likely be found in central Europe?
a. Thunderstorms and snow
b. Thermal depressions
*c. Northerly Foehn wind over the Alps
d. Warm, clear sunny spells
Explanation: In the diagram above, low pressure in the Mediterranean gives Bora winds in Central Europe. The Bora is part valley wind and part katabatic. It blows down the north Adriatic with high pressure over Central Europe and the Balkans and a low over the Adriatic. The wind speed is around 70kts with great gusts exceeding 100kts in places. The Bora is strongest and most frequent in winter.

22. Which of the following will give the greatest difference between temperature and dew point?
*a. Dry air
b. Moist air
c. Cold air
d. Warm air
Explanation: The dew point is the temperature to which a parcel of air must be cooled, at constant pressure, for water vapour to condense. A high relative humidity means the dew point is close to the current temperature; at 100% RH the dew point equals the air temperature. Since the dew point can never exceed the air temperature, warmer air (with a lower relative humidity) gives the greatest difference between temperature and dew point.

23. Using the diagram below you are on a flight from A to B at 1500 ft. Which statement is true?
a. True altitude at A is greater than B
*b. True altitude at B is greater than A
c. True altitude is the same
d. Cannot tell
Explanation: A= closely packed iso bars indicate low pressure B= Widely spaced isobars indicate high pressure flying from low to high pressure true altitude will increase

24. When do you mainly get cold occlusions?
*a. Summer
b. Autumn and winter
c. Winter
d. Winter and spring
Explanation: The air behind the cold front is colder than the air ahead of the warm front, so a cold-type occlusion forms. (Source notes this type of occlusion is more common in summer.)

25. A coded SIGMET message for Athens reads “TS W Athenia MOV E”
...
Explanation: TS – means thunderstorm W – means coming from west Athenia- (it means meant for athens) MOV E- means moving east

26. In a very deep depression in Iceland, the likely weather is
a. convection causing snow
b. high wind, clear vis
*c. high wind, rain, snow
d. high wind shear
Explanation: depression means low pressure system like cyclone or thunderstorm relates to high wind, rain, snow

27. In a METAR/TAF what is VV?
a. RVR in metres
b. Vertical visibility
c. Horizontal visibility in metres
*d. Vertical visibility in feet
Explanation: If the sky at an aerodrome is obscured for reasons other than cloud cover, and cloud coverage cannot easily be determined, the code VV is used in place of the cloud information. VV is followed by the vertical visibility in hundreds of feet

28. In an METAR the cloud height is above
a. MSL
*b. Aerodrome level
c. The measuring station
d. The highest point within 5Km
Explanation: The height above aerodrome level of the lowest layer of cloud of more than 4 oktas”

29. Air at the upper levels of the atmosphere is diverging. What would you expect at the surface?
...
Explanation: upper level divergence means lower level convergence, hence low pressure system

30. What happens to the stability of the atmosphere in an inversion? (Temp increasing with height)
*a. Absolutely stable
b. Unstable
c. Conditionally stable
d. Conditionally unstable
Explanation: Air is stable whenever the ELR is less than 0.6°C/100m. In inversion ELR is less than 0.6°C/100m.as temp increases with height

31. What happens to stability of the atmosphere in an isothermal layer? (Temp constant with height)
*a. Absolutely stable
b. Unstable
c. Conditionally stable
d. Conditionally unstable
Explanation: Air is stable whenever the ELR is less than 0.6°C/100m. In isotherm lapse rate is 0 as temp remains same

32. Air temperature in the afternoon is +12°C with a dew point of +5°C. What temperature change must happen for saturation to occur?
*a. cool to +5°C
b. cool by 5°C
c. cool to +6°C
d. cool to +7°C
Explanation: When temperature and dew point are same saturation occurs and fog formation takes place

33. What is the gradient of a warm front?
a. 1:50
*b. 1:150
c. 1:300
d. 1:500

34. Subsidence would be described as
a. Vertical ascension of air
b. Horizontal movement of air
c. The same as convection
*d. Vertical down flow of air
Explanation: subsidence occurs in high pressure

35. What is the technical term for an increase in temperature with altitude?
*a. Inversion
b. Advection
c. Adiabatic
d. Subsidence
Explanation: 1. Inversion is also called negative lapse rate Where the temperature increases with an increase in height, then we have what is called an inversion. We have already seen that at night we can expect an inversion above the surface, but this can occur in many different ways.

36. The Pampero is
a. Marked movement of cold polar air in North America
*b. Marked movement of cold air in South America
c. Foehn type wind in North America
d. Polar air over the Spanish Pyrenees
Explanation: The pampero is a burst of cold polar air from the west, southwest, or south on the pampas in the south of Brazil, Argentina, Uruguay, Paraguay and Bolivia

37. Winds in western India
*a. SW monsoon in summer, NE monsoon in winter
b. NE monsoon in summer and SW monsoon in winter
c. SE monsoon in summer and SW monsoon in
d. SE monsoon in summer and NE monsoon in winter

38. Ice pellets on the ground are evident that
...
39. You have to fly through a warm front. The freezing level in the warm air is at 10,000ft and the freezing layer in the cold air is at 2,000ft. Where are you least likely to encounter freezing rain?
*a. 12,000ft
b. 9,000ft
c. 5,000ft
d. 3,000ft
Explanation: The level at which temperature is zero is called the freezing level. Freezing rain occurs when rain falls from an inversion layer into air below 0°C. Rain in the warm air falls from above 10,000ft, since 10,000ft is the freezing level; 12,000ft can be considered part of the inversion, as it is warmer, being in the warm sector.

40. You are flying at FL170. The pressure level which is closest to you is the
a. 300mb
b. 700mb
*c. 500mb
d. 850mb
Explanation: Refer the chart 500 hpa is 18000 pressure altitude

41. When you have icing conditions forecast on-route, on what chart would you find this information?
a. 500hPa
b. 300hPa
c. Surface charts
...
42. The average duration of a microburst
*a. 1-5 mins
b. 10mins
c. 15mins
d. less than 2mins
...
`);
registerChapterText("atpl-met", "part-6", "Part 6", `
1. How is QFE determined from QNH?
...
2. With the approach of a warm front
*a. QNH/QFE decreases
b. QNH/QFE increases
c. QNH decreases and QFE increases
d. QNH increases and QFE decreases
Explanation: as in the table pressure falls hence qfe and qnh will fall

3. With the approach of a cold front, temperature will
a. Decrease
*b. Remain the same
c. Increase
d. Decrease then increase
Explanation: temperture remains the same With the approach of a cold front as the leading air mass is warm

4. On a surface weather chart, isobars are lines of
a. QNH
b. QFE
*c. QFF
d. QNE
Explanation: QFF is The value of pressure reduced to MSL in accordance with isothermal conditions. Isobars are line joining places of the same atmospheric pressure (usually MSL pressure QFF).
...
Explanation: Vertical windshear is change in wind velocity with height. It is typically measured in knots per 100ft. This type of windshear is very common during an inversion, therefore expect them at night under the sub tropical high pressure belt. As an aeroplane fly’s through an inversion, not only will the change of temperature cause the engine performance to change, but the abrupt change in wind speed and direction may significantly alter the flight path.

6. Air temperature is 12°C, Dew point is 10°C and the sea temperature is 8°C. What might you expect if the air is blown over the sea?
a. Steaming fog
b. Radiation fog
c. Arctic smoke
*d. Advection fog

7. A cold pool over land in summer would give rise to:
a. Clear skies
b. Low stratus with intermittent rain
*c. A potentially very unstable atmosphere
d. Extensive industrial haze
Explanation: These are outbreaks of cold air from near the poles. These outbreaks are usually characterized by a cold front at their leading edge. Although surface temperature anomalies such as cold pools are not evident on surface pressure charts, they can be found most notably by looking at pressure charts in the middle to upper atmosphere. You may remember that cold air causes pressure to fall more rapidly with height, reducing the pressure in the upper atmosphere. Therefore by analyzing a pressure chart in the middle to upper atmosphere you can identify cold air pools by the low pressure they create, Low pressure is accompanied by showers and thunderst

8. Near industrial areas with lots of smoke what the worst situation is for met vis:
*a. Low level inversion
b. Strong winds
c. Fast moving cold fronts
d. Cb’s in the area
Explanation: Temperature inversion, also called thermal inversion, a reversal of the normal behaviour of temperature in the troposphere (the region of the atmosphere nearest Earth’s surface), in which a layer of cool air at the surface is overlain by a layer of warmer air. (Under normal conditions air temperature usually decreases with height.) Inversions play an important role in determining cloud forms, precipitation, and visibility. An inversion acts as a cap on the upward movement of air from the layers below. As a result, convection produced by the heating of air from below is limited to levels below the inversion. Diffusion of dust, smoke, and other air pollutants is likewise limited.

9. Upper level winds are forecast in significant weather charts as:
*a. True/knots
b. Magnetic/knots
c. Magnetic/km/h
d. True/km/h2
Explanation: Wind speed is usually given in knots, but some countries give the speed in metres per second and the Met. Wind direction is always given as the direction from which the wind is blowing. It is normally given in degrees true, but wind direction given to a pilot by ATC or in an ATIS will be given in degrees magnetic

10. How often are METAR’s issued at Main European Airfields?
a. 1 hr
*b. 30 mins
c. 3 hrs
d. 1 hr 30 mins
Explanation: metar is issued every 30 minutes almost everywhere in the world

11. What are the TRS of the west coast of Africa called?
a. Typhoons
b. Cyclones
c. Easterly waves
*d. Hurricanes

12. The most severe in-flight icing occurs in:
a. Cb
b. Cu
c. Ns
*d. FZRA
Explanation: Freezing rain is the most dangerous form of icing and it occurs in rain which becomes supercooled by falling through an inversion into air below 0°C. The supercooled water droplets are now rain aerofoil it freezes to form clear ice with significant flowback. Freezing rainbuilds up very quickly and a pilot’s action should be to turn onto a reciprocal heading immediately. If the pilot perceives the rain ice very late, then the course of action would be to climb into the warmers layers above. Turning at a late stage into the icing conditions will increase the stall speed and the return journey back out of the rain ice zone will double the ice on the aircraft from when the pilot first elected to turn around.

13. Which of the following constituents in the atmosphere has the greatest effect on the weather?
a. Nitrogen
b. Oxygen
c. Hydrogen
*d. Water Vapour
Explanation: THE CONSTITUENTS OF THE ATMOSPHERE Nitrogen 78 % Argon 0.95% Oxygen 21 % Carbon Dioxide 0.05% Plus traces of: Monoxide Xenon Sulphur Dioxide Hydrogen Ammonia Methane Iodine and Ozone Water Vapour Of all the trace gases, water vapour is by the far the most significant. Without it there would be no weather.

14. What type of cloud extends into another level?
a. As
b. Acc
*c. Ns
d. Ci
Explanation: Nimbostratus is also a medium-level cloud, but it may also extend into both the lower and upper levels of the atmosphere

15. Ceilometers measure
a. RVR
*b. Cloud height
c. Met Vis
d. Turbulence
Explanation: As the name suggests, a ceilometer measures 'cloud ceiling', i.e. height.

16. In a METAR, the pressure group represents
...
Explanation: QNH values are given in hectopascals (HPA) rounded down to the nearest lower whole hectopascal

17. On a Station circle decode, the cloud cover is divided into
*a. 8 parts
b. 6 parts
c. 4 parts
d. 10 parts
Explanation: 8 parts also called oktas
...
Explanation: Qnh is 1013 only under isa conditions which is hypothetical

19. When does Darwin (Australia. experience TRS?
a. June and July
*b. December to March
c. Early summer
d. Not at all
...
20. Radiation fog extends from the surface to:
a. 5000ft
b. 2000ft
c. 10,000ft
*d. 800ft
Explanation: Radiation fog is caused by radiation of the earth's heat at night, and the subsequent conductive cooling of the air in contact with the ground to below dew point. If there is a light wind, fog will form; in calm conditions the result will be the formation of dew instead. The fog is not usually more than a few hundred feet thick.

21. Flying from Marseilles to Palma you discover your true altitude is increasing, but oddly the QNH is identical at both places. What could be the reason?
a. Re-check the QNH
b. Re-check the radio altimeter
*c. The air at Palma is warmer
d. Palma is lower than Marseilles
Explanation: If temperature is warmer than ISA then TRUE > INDICATED and if it’s colder than ISA

22. Low level inversions
a. Good vis at night
...
Explanation: In a HIGH there is divergence of wind towards the low pressure region and no vertical movement of air, so fog, mist or haze stays put - hence poor visibility. Inversions occur in highs.
...
Explanation: TREND forecast is valid for 2 hours after the time of the observation of the METAR, and constitutes the final section of the METAR. The change in weather conditions indicated by the code, TREND, can be further qualified by the codes, BECMG, meaning becoming, or TEMPO meaning temporarily.

24. QNH is 1030. Aerodrome is 200m AMSL. What is QFF?
a. Higher than 1030
b. Lower than 1030
c. Same
*d. Not enough info

25. Where are down draughts predominant in a thunderstorm?
a. Mature
*b. Dissipating
c. Initial
d. Cumulus
...
Explanation: VV IS vertical visibility 100 is in feet as the visibility is always in feet not metre

27. The line connecting C to D crosses which type of front?
a. Cold front
*b. Warm front
c. Warm occlusion
d. Cold occlusion
Explanation: triangles,are the standard symbols denoting a cold front.
...
d. A low
Explanation: A col, also called saddle point or neutral point, is in meteorology, the point of intersection of a trough and a ridge in the pressure pattern of a weather map. It takes the form of a saddle where the air pressure is relatively higher than that of the low- pressure regions

29. On a particular day the PFJ runs north to south in the Northern Hemisphere
...
Explanation: Polar front jetstreams form in the polar front region in both hemispheres,in southern around 50° S and near any front which is separate from the polar front. The upper winds will blow such that looking downstream the cold air will be to the left hand side in northern hemisphere and to the right hand side in the southern hemisphere. polar air is cold air hence if pfj travels south polar air will be east

30. A 350 kt jet stream is
a. Impossible
...
31. Where would an anemometer be placed?
a. close to station, 2m above ground
b. on the roof of the station
*c. 10m above aerodrome elevation on a mast
d. next to the runway, 1m above ground
Explanation: Surface wind is measured by a wind vane which aligns itself with the wind direction, and an anemometer which measures the speed. An anemometer is a set of 3 hemispherical cups which rotate on a shaft with the effect of the wind. The speed of rotation of the shaft is directly proportional to the windspeed. The rotation is used to drive a small generator, the output of which is then displayed on a gauge which is calibrated in knots. Both vane and anemometer are positioned 33 ft (10 m) AGL and they are located clear of buildings and obstructions which could affect the airflow and hence accuracy. An anemograph records windspeed and sometimes direction.

32. 90km/hr wind in kts is:
a. 70
b. 60
*c. 50
d. 30
Explanation: 90 km = 48.6 nautical mile

33. When landing at Dakar in July, the weather to be expected is:
a. Clear and dry
...
34. When is the Hurricane season in the Caribbean?
*a. July to November
b. October to January
c. January to April
d. April to July
Explanation: TRS are given different names in different parts of the world. Either side of North America these storms are called Hurricanes. In the Indian Ocean and around Australia they are called Cyclones and around the far east, they called Typhoons. Typhoons are the most violent and have the longest season of any TRS. Indian Ocean touches MADAGASCAR november December and January Has high humidity and trade winds hence trs forms during this time

35. An aircraft is stationary on the ground. With the passage of an active cold front its altimeter will show:
*a. An increase then a decrease
b. Will fluctuate ± 50ft
c. A decrease then an increase
d. Remain constant
Explanation: PRESSURE WILL FALL, ALTIMETER INCREASE PRESSURE WILL RISE, ALTIMETER DECREASE

36. What is the average vertical extent of radiation fog?
a. 2,000 ft
*b. 500 ft
c. 5,000 ft
d. 10,000 ft
Explanation: Radiation fog is caused by radiation of the earth’s heat at night, and the subsequent conductive cooling of the air in contact with the If there is a light wind, then fog will form, in calm conditions the result will be the formation of dew. The fog is not usually more than a few hundred feet thick.

37. Where is clear ice most likely in a Cb?
...
38. You have to make an emergency ditch at sea. The QNH of a nearby island airfield is 1025mb, airfield elevation 4000ft. The temp is -20°C. With 1025 set on your sub-scale, on ditching the altimeter will read:
a. 0 ft
*b. Less than 0 ft
c. > 0 ft but less than 4000 ft
d. 4000 ft
Explanation: TEMP IS -20 WHICH IS -ISA AERODROME IS 4000 FT ABOVE MSL HENCE QFF IS GREATER THEN QNH IF QFF> QNH QFF WILL HAVE A VALUE 1025 OR ABOVE AND AS PER PRESSURE LEVEL CHART ALTIMETER WILL READ LESS THAN 0 FEET

39. Which of the following will indicate medium level instability, possibly leading to thunderstorms?
a. Halo
*b. Altocumulus Castellanus
c. Altocumulus Capillatus
d. Red Cirrus
Explanation: Altocumulus castellanus is a “bubbly” form of normal altocumulus. The “towers” that form in altocumulus castellanus are like battlements on castles, hence the name. These clouds are significant because they often herald a change to showery, thundery weather and are a feature of summer weather in temperate latitudes. castellanus, when instability is present at medium levels of the Troposphere.

40. Radiation fog extends to:
a. 8,000 ft
b. 4,000 ft
c. 2,000 ft
*d. 500 ft
Explanation: Radiation fog is caused by radiation of the earth’s heat at night, and the subsequent conductive cooling of the air in contact with the ground to below dew point. If there is a light wind, then fog will form, in calm conditions the result will be the formation of dew. The fog is not usually more than a few hundred feet thick.

41. In association with CB in temperate latitudes, at about what levels can hail be anticipated?
a. Ground to FL100
b. Ground to FL200
c. Cloud base to FL200
*d. Ground to FL450
Explanation: Cb extends from the lowest level up to FL450; in the presence of Cb, hail can be expected.

42. +TSRA come from what sort of cloud?
*a. Cb
b. Ns
c. Cc
d. Cu
Explanation: MEANS HEAVY INTENSITY – MEANS LIGHT CB GIVES HEAVY INTENSITY TSRA (THUNDER SHOWER AND RAIN)

`);
registerChapterText("atpl-met", "part-7", "Part 7", `
1. Flying 2500 ft below core of jet, with temperature increasing in the Southern Hemisphere, where does the wind come from?
a. Head
b. Tail
*c. Left
d. Right
Explanation: With your back to the upper wind, the cold air is to your left in the northern hemisphere and to your right in the southern hemisphere.” jet streams are mostly from west to east

2. Secondary depressions move
*a. Around the primary in a cyclonic fashion
b. Around the primary in an anticyclonic fashion
c. Eastwards
d. Westwards
Explanation: This secondary may deepen and form the next depression along the PF and equal the size of the primary. At this stage, the depressions tend to rotate around each other cyclonically

3. As an active cold front passes, the altimeter of an a/c parked on the apron
*a. Increases then decreases
b. Fluctuates by ± 50 ft
c. Decreases then increases
d. Remains unchanged
Explanation: warm air to cool. The water vapour in the warm air mass, consequently, condenses, and clouds are created. The slope of the cold front boundary is steeper than that of the warm front, with a gradient of approximately one in fifty. The unstable air just ahead of the cold front is, forced to rise vigorously. Causing pressure to reduce and altimeter reading increased

4. Where does a TRS gain its energy from?
...
Explanation: Hurricanes. Hurricane is the name given to Tropical Revolving Storms in the Caribbean/Gulf of Mexico Area. Frequency of developed Hurricanes is average 3 per year. They occur from August to October, tracking knots. Internal windspeeds can exceed 100 knots. They then cross the Bay of Mexico or turn right around the sub tropical high to track NW, N, NE up the USA East Coast. They are energised by the latent heat of condensation and are therefore more active over the sea. Each season they are named alphabetically in order of occurrence using alternate male/female first names.

5. What is the height and temperature of Tropopause?
a. 8km and -40°C at Equator
*b. 16km and -75°C at Equator
c. 16km and -40°C at Pole
d. 8 km and -75°C at Pole
Explanation: over the poles, the tropopause can be between 8 -10 km and over the equator 16 – 18 km The lower it is, the warmer the temperature at the tropopause. The temperature at the tropopause can be as high as -40°C over the poles and as low as -80°C over the equator.

6. What is the Easterly wave?
...
7. What is in position A?
a. col
b. Ridge of high pressure
*c. A low
d. A high CLOSED PACKED ISOBARS MEAN LOW PRESSURE

8. The Geostrophic Wind blows at your flight level in Northern Hemisphere, true altitude and indicated altitude remain constant, is the crosswind
a. From the left
b. From the right
*c. No crosswind
d. Impossible to determine
Explanation: true altitude and indicated altitude remains same hence no cross wind AS PER BUY BALLOTS LAW

9. What is the base of alto cumulus in summer?
a. 0 -1500’
b. 1500 -7000’
c. 7000’ -15000’
*d. 7000’ -16500’

10. What is the general height of radiation fog?
*a. 500’
b. 2000’
c. 3000’
d. 1500
...
11. When a CC layer lies over a West European plane in summer, with a mean terrain height of 500 m above sea level, the average cloud base could be expected
...
12. Which of the following cloud types can stretch across all three cloud levels (low, medium and high level)?
a. CI
b. ST
c. AC
*d. CB
Explanation: CB EXTENDS FROM LOWEST LEVEL TO FL 450, IN PRESENCE OF CB HAIL CAN BE EXPECTED

13. Which of the following cloud types can stretch across at least two cloud levels?
a. ST
*b. NS
c. CI
d. SC

14. Flying at FL 135 above the sea, the Radio Altimeter indicates a true altitude of 13500 ft. The local QNH is 1019 hPa. Hence the crossed air mass is, on average,
a. At ISA standard temperature
*b. Colder than ISA
c. Warmer than ISA
d. There is insufficient information to determine the average temperature deviation
Explanation: If the QNH was 1013mb, you’d be at 13,500 feet when at FL135. if you increased the subscale setting to 1019 the indication would increase, but as per radio altimeter it remains 13500, this means that air mass was cold as true altitude decreases in cold air

15. Which air mass has the coldest temperature?
a. AM
b. PM
*c. PC
d. TM
Explanation: If the airmass is lying over a warm tropical ocean, it is classified as Tropical Maritime (TM). If the airmass lies over a cold continent in winter, it is classified as Polar Continental (PC).

16. What happens to an aircrafts altimeter on the ground at the approach of a cold front?
a. increases then decreases
b. decreases then increases
c. remains the same
*d. increases

17. You are flying in the Alps at the same level as the summits on a hot day. What does the altimeter read?
a. Same altitude as the summit
b. Higher altitude as the summit
*c. Lower altitude as the summit
d. Impossible to tell
Explanation: As a thumb rule if it’s warmer than ISA then TRUE > INDICATED and if it’s colder than ISA then TRUE < INDICATED. altimeter shows indicated altitude hence lower altitude than summit

18. What cloud is between a warm and cold front?
*a. St with drizzle
b. Cs
c. Ns
d. St with showers
Explanation: The area lying between the two fronts is known, since it is covered by tropical air, as the warm sector. In the warm sector. Surface W/V – Steady, usually from the SW. Temperature – Steady. Dew Point – Steady. Pressure – Steadily decreasing. low, St, Sc. In summer over land – fair weather cumulus Precipitation – Light rain, drizzle Visibility – Poor.

19. From which cloud do you get hail?
a. Sc
*b. Cb
c. Ns
d. Ts

20. When flying from south to north in the Southern Hemisphere, you cross over the Polar Front Jet. What happens to the temperature?
*a. it increases
b. it decreases
c. it remains the same
d. impossible to determine
Explanation: PFJ ARE LOCATED IN WARM AIR

21. To dissipate cloud
*a. Subsidence
b. Decrease in temperature
c. Increase pressure
d. Convection
Explanation: An inversion in the atmosphere is where temperature rises with an increase in height. This produces extreme stability and inhibits the formation of cloud In a high pressure system, air descends at the centre. As the air descends it will be heated adiabatically and will be warmer than the air at a lower level adjacent to the surface. This is called a Subsidence Inversion.

22. You will get least amount of icing in which cloud?
a. NS
b. SC
*c. CS
d. AS

23. Isolated TS in summer are because of
*a. Convection
b. Cold fronts
c. Warm front occlusions
d. Cold front occlusions
Explanation: Heat, or airmass type (more common in summer time). Also called isolated are formed by thermal triggering not by frontal uplift

24. On a significant weather chart you notice a surface weather front with an arrow labelled with the no. 5 pointing outward perpendicular from the front. This would indicate
*a. Front speed is 5kts
b. Front movement is 5nm
c. Front thickness is 5km
d. front is 5000ft AMSL

25. With all other things being equal with a high and a low having constantly spaced circular isobars. Where is the wind the fastest?
*a. Anticyclonic
b. Cyclonic
c. Where the isobars are closest together
d. Wherever the PGF is greatest
Explanation: If air is moving steadily around a high, the centrifugal force acts with the Pressure Gradient Force (PGF), increasing the velocity of the wind.

26. Blocking Anticyclones prevent the polar front from arriving over the UK and originate from?
...
d. Warm anabatic
Explanation: The Föhn Wind is a warm dry wind which blows on the downwind side of a mountain range. It is a local wind in the Alps

28. Cu is an indication of
*a. vertical movement of air
b. stability
c. the approach of a warm front
d. the approach of a cold front
Explanation: Cumulus cloud is the most common form of convective cloud, being classified as heaped cloud, from Latin cumulare meaning to heap up. For glider pilots, a developing cumulus is regarded as a reliable indication of the presence of thermal upcurrents developed cumulus cloud is generally dense, with sharp outlines. As it continues to develop vertically, a cumulus cloud forms mounds, domes or towers, of which the upper parts often resemble the head of a cauliflower

29. Which clouds are evidence of stable air?
*a. St, As
b. Cb, Cc
c. Cu, Ns
d. . Cu, Cb
Explanation: Stratus (from Latin stratum, meaning strewn) is generally a grey, layered cloud with a fairly uniform base, which may produce drizzle, or light snow. Stratus cloud is no more than 1,000 – 1 500 ft thick, and is often much thinner

30. Lack of cloud at low level in a stationary high is due to:
a. instability
b. rising air
*c. sinking air
d. divergence at high level
Explanation: Clouds form with rising air, not sinking air, high pressure has air sinking in the centre

31. Which of the following is an example of a Foehn wind?
a. Bora
b. Harmattan
*c. Chinook
d. Ghibli
Explanation: Although Föhn winds blow in the Alps, the name is used generically to describe winds which blow with similar effect in other parts of the world. One such wind is the Chinook which blows on the Eastern side of the Rocky mountains of North America.

32. What happens to the temperature of a saturated air mass when forced to descend?
...
Explanation: Saturated air that is either forced to rise or descend within the atmosphere will change its temperature, on average by 0.6°C per 100 m (1.8°C/1000 ft). The SALR varies strongly with the moisture content, which when saturated, depends on temperature, and pressure of the air parcel. dalr temp will increase 1°C per 100 m, it will heat up more than salr

33. The Tropopause is lower:
...
Explanation: The warmer the air, the higher the tropopause; the colder the air, the lower the tropopause. Generally over the poles the tropopause is between 8-10km, and over the equator 16-18km.

34. An airfield has an elevation of 540ft with a QNH of 993mb. An aircraft descends and lands at the airfield with 1013mb set. What will its altimeter read on landing?
a. 380ft
*b. 1080ft
c. 0ft
d. 540ft
Explanation: 1013 will be below 993 in atmosphere 20 hpa difference will add 540 feet Under normal conditions, pressure varies by 1 hPa per 27 feet. hence add 540 to current altitude 1080 feet with 1013 set

35. In a METAR a gust is reported when:
...
Explanation: mean speed taken over 10 minutes, gust reported 10 knots

36. When is pressure altitude equal to true altitude?
...
Explanation: True Altitude = Pressure Altitude plus(ISA Deviation × 4/1000 × Indicated Altitude) if deviation is 0 true altitude is equal to pressure altitude which is only in international standard condition

37. What is the relationship between QFE and QNH at an airport 50ft below MSL?
a. QFE = QNH
b. QFE < QNH
*c. QFE > QNH
d. There is no clear relationship

38. Where would a pilot find information about the presence of a jet stream?
a. On an Upper Air chart
*b. On a Significant Weather chart
c. On a Surface Analysis chart
d. On a Wind/Temperature chart
Explanation: Significant Weather (SIGWX) charts provide valuable meteorological information to aircraft operators and flight crew. Particularly for longer flights, or when weather issues may be a factor, SIGWX charts can be a vital flight planning tool. the only cloud shown in waf sigwx chart is CB moderate and severe icing is associated to a cb AND INFORMATION ON JET STREAM AND CLEAR AIR TURBULENCE

39. What is the effect of a mountain valley wind?
...
Explanation: A wind blowing against a mountain is impeded. If the barrier is broken by a gap or valley, the wind will blow along the valley at an increased speed due to the restriction.

40. What is the name of the dry, dusty wind blowing in North West Africa from the North East?
a. Pampero
b. Khamsin
*c. Harmattan
d. Ghibli
...
41. What is the difference between Gradient and Geostrophic winds?
a. Difference in temperatures
b. A lot of friction
*c. Curved isobars and straight isobars
d. Different latitudes and densities
Explanation: The gradient wind occurs when the isobars are curved. The Geostrophic Wind blows parallel to straight isobars.

42. In still air a lapse rate of 1.2°C/100m refers to:
a. DALR
b. SALR
*c. ELR
d. ALR
Explanation: ELR is not a fixed value, whereas the Saturated Adiabatic Lapse Rate is 0.6°C per 100m (1.8°C/1000ft), and unsaturated/dry air has a lapse rate of 1°C per 100m (3°C/1000ft).

43. Flying from A to B at a constant indicated altitude in the northern hemisphere.
a. True altitude increases
b. Wind is northerly
*c. True altitude decreases
d. Wind is southerly
Explanation: when you fly from high to low altimeter overreads also in a low Pressure area indicated altitude is more than true altitude hence true altitude is lower as indicated altitude is same.
